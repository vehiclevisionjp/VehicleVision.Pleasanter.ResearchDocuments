...
- [実装手順](#実装手順)
    - [ステップ 1: Security パラメータへの追加](#ステップ-1-security-パラメータへの追加)
    - [ステップ 2: CanDelete メソッドの改修](#ステップ-2-candelete-メソッドの改修)
    - [ステップ 3: CanUpdate メソッドの改修](#ステップ-3-canupdate-メソッドの改修)
    - [ステップ 4: エラーメッセージの追加（オプション）](#ステップ-4-エラーメッセージの追加オプション)
...
`Implem.ParameterAccessor/Parts/Security.cs` に新規パラメータを追加:
