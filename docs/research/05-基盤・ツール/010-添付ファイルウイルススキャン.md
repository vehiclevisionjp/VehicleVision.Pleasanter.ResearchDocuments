...
| --- | ---------------------------------------- | :--------------------: | :--: | :--------: | ------------------- |
| 1   | ClamAV（clamd デーモン）                 |           ✅           |  ✅  |     低     | デーモン TCP/Unix   |
| 2   | ClamAV（clamscan コマンド）              |           ✅           |  ✅  |    最低    | プロセス起動        |
| 3   | Windows Defender（AMSI）                 |           ❌           |  ✅  |     中     | COM/P/Invoke        |
| 4   | Windows Defender（MpCmdRun.exe）         |           ❌           |  ✅  |     低     | プロセス起動        |
| 5   | YARA ルールスキャン                      |           ✅           |  ✅  |     中     | ライブラリ/プロセス |
| 6   | VirusTotal API（無償枠）                 |           ✅           |  ✅  |     低     | REST API            |
| 7   | OS 標準 AV 連携（AMSI / clamd 自動判別） |           ✅           |  ✅  |     中     | 複合                |
