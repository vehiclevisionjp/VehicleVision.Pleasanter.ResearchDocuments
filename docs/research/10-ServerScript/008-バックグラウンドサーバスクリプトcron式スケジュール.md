...
**cronstrue** は Quartz 形式の 7 フィールド cron 式にも対応しており、30 以上の言語（日本語含む）での説明文生成が可能である。
...
// 日本語で説明を生成
cronstrue.toString('0 */15 9-17 ? * MON-FRI *', { locale: 'ja' });
// → "月曜日 から 金曜日まで, 09:00 から 17:59まで, 15 分ごと"
```
