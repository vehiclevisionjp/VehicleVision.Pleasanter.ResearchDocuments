...
- [プリザンター ユーザアクセス権限・アクセス制御 実装調査](#プリザンター-ユーザアクセス権限アクセス制御-実装調査)
  - [調査情報](#調査情報)
  - [調査目的](#調査目的)
  ...
  - [権限主体の階層構造](#権限主体の階層構造)
    ...
    - [特権レベル](#特権レベル)
      ...
      - [特権ユーザ（HasPrivilege）](#特権ユーザhasprivilege)
        - [特権ユーザがバイパスする機能一覧](#特権ユーザがバイパスする機能一覧)
        - [ユーザ切替（SwitchUser）機能](#ユーザ切替switchuser機能)
      - [テナント管理者（TenantManager）](#テナント管理者tenantmanager)
      - [サービス管理者（ServiceManager）](#サービス管理者servicemanager)
      - [委任管理（EnableManageTenant）](#委任管理enablemanagetenant)
      - [グループ管理の制御](#グループ管理の制御)
